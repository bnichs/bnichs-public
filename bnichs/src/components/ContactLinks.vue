...
<template>
  <div v-if="showEmail" class="contact">
  ...
  <div v-if="showLinkedin" class="contact">
  ...
  <div v-if="showGitHub" class="contact">
  ...
  <div v-if="showCard" class="contact">
    <RouterLink to="/card">
      <WelcomeItem>
        <template #icon>
        ...
        <span class="text">
            See my business card designed here on the website.
          </span>
      </WelcomeItem>
    </RouterLink>
  </div>
